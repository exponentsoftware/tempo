...
},{"./key_stores/browser-index":"../node_modules/near-api-js/lib/key_stores/browser-index.js","./common-index":"../node_modules/near-api-js/lib/common-index.js","./browser-connect":"../node_modules/near-api-js/lib/browser-connect.js","error-polyfill":"../node_modules/error-polyfill/index.js"}],"assets/js/near/config.js":[function(require,module,exports) {
"use strict";

var _nearApiJs = require("near-api-js");

var CONTRACT_NAME = "dev-1661254310264-94506501695144" || 'new-awesome-project';
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js"}],"assets/js/near/utils.js":[function(require,module,exports) {
var define;
"use strict";
...
exports.latestDonations = latestDonations;
exports.login = login;
exports.logout = logout;

var _nearApiJs = require("near-api-js");

var _rpc_errors = require("near-api-js/lib/utils/rpc_errors");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _nearApiJs.connect)(nearConfig);

          case 2:
            window.near = _context.sent;
            // Initializing Wallet based Account. It can work with NEAR testnet wallet that
            // is hosted at https://wallet.testnet.near.org
            window.walletConnection = new _nearApiJs.WalletConnection(window.near); // Initializing our contract APIs by contract name and configuration
...
function getTransactionResult(_x) {
  return _getTransactionResult.apply(this, arguments);
}

function _getTransactionResult() {
  _getTransactionResult = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(txhash) {
    var transaction;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return window.near.connection.provider.txStatus(txhash, window.walletConnection.getAccountId());

          case 2:
            transaction = _context2.sent;
            return _context2.abrupt("return", _nearApiJs.providers.getTransactionLastResult(transaction));
...
function getBeneficiary() {
  return _getBeneficiary.apply(this, arguments);
}

function _getBeneficiary() {
  _getBeneficiary = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
...
function latestDonations() {
  return _latestDonations.apply(this, arguments);
}

function _latestDonations() {
  _latestDonations = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var total_donations, min, donations, i, amount, rounded_two_decimals;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return window.contract.total_number_of_donation();

          case 2:
            total_donations = _context4.sent;
            min = total_donations > 10 ? total_donations - 9 : 1;
            _context4.next = 6;
            return window.contract.get_donation_list({
              from: min,
              until: total_donations
            });

          case 6:
            donations = _context4.sent;

            for (i = 0; i < donations.length; i++) {
              amount = _nearApiJs.utils.format.formatNearAmount(donations[i].amount);
              rounded_two_decimals = Math.floor(amount * 100) / 100;
              donations[i].amount = rounded_two_decimals;
              donations[i].number = min + i;
            }

            return _context4.abrupt("return", donations);
...
function _donate() {
  _donate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(amount) {
    var response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            amount = _nearApiJs.utils.format.parseNearAmount(amount.toString());
            _context5.next = 3;
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","near-api-js/lib/utils/rpc_errors":"../node_modules/near-api-js/lib/utils/rpc_errors.js","./config":"assets/js/near/config.js"}],"assets/js/index.js":[function(require,module,exports) {
"use strict";
...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var _event$target$element, fieldset, donation;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, fieldset = _event$target$element.fieldset, donation = _event$target$element.donation; // disable the form while the value gets updated on-chain

            fieldset.disabled = true;
            _context.prev = 3;
            _context.next = 6;
            return (0, _utils.donate)(donation.value);
...
function _fetchBeneficiary() {
  _fetchBeneficiary = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var currentGreeting;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _utils.getBeneficiary)();

          case 2:
            currentGreeting = _context3.sent;
            // Set all elements marked as greeting with the current greeting
            document.querySelectorAll('[data-behavior=beneficiary]').forEach(function (el) {
...
function _signedInFlow() {
  _signedInFlow = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var urlParams, txhash, result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            // Displaying the signed in flow container
            document.querySelectorAll('.signed-in-flow').forEach(function (elem) {
              return elem.style.display = 'block';
            }); // Check if there is a transaction hash in the URL (come back from a donation)

            urlParams = new URLSearchParams(window.location.search);
            txhash = urlParams.get("transactionHashes");
            ...
            _context4.next = 6;
            return (0, _utils.getTransactionResult)(txhash);

          case 6:
            result = _context4.sent;
            document.querySelector('[data-behavior=donation-number]').innerText = result; // show notification
...
function getAndShowDonations() {
  return _getAndShowDonations.apply(this, arguments);
}

function _getAndShowDonations() {
  _getAndShowDonations = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var donations;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            document.getElementById('donations-table').innerHTML = 'Loading ...'; // Load last 10 donations

            _context5.next = 3;
            return (0, _utils.latestDonations)();

          case 3:
            donations = _context5.sent;
            document.getElementById('donations-table').innerHTML = '';
            donations.forEach(function (elem) {
              var tr = document.createElement('tr');
              tr.innerHTML = "\n      <tr>\n        <th scope=\"row\">".concat(elem.number, "</th>\n        <td>").concat(elem.donor, "</td>\n        <td>").concat(elem.amount, "</td>\n      </tr>\n    ");
...
window.set_donation = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(amount) {
    var data, near2usd, amount_in_near, rounded_two_decimals;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("https://api.coingecko.com/api/v3/simple/price?ids=near&vs_currencies=usd").then(function (response) {
              return response.json();
            });

          case 2:
            data = _context2.sent;
            near2usd = data['near']['usd'];
            amount_in_near = amount / near2usd;
            rounded_two_decimals = Math.round(amount_in_near * 100) / 100;
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./near/utils":"assets/js/near/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
